                        ...
                        {menuItem.path ? (
                          <Link
                            ...
                            className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
                              usePathName === menuItem.path
                                ...
                                : "text-dark hover:text-pink-600 dark:text-white/70 dark:hover:text-pink-600"
                            }`}
                          >
                            {menuItem.title}
                          </Link>
                          ...
                          <>
                            <p
                              ...
                              className="flex cursor-pointer items-center justify-between py-2 text-base text-dark group-hover:text-pink-600 dark:text-white/70 dark:group-hover:text-pink-600 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6"
                            >
                              {menuItem.title}
                              <span className="pl-3">
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, index) => (
                                <Link
                                  ...
                                  key={index}
                                  className="block rounded py-2.5 text-sm text-dark hover:text-pink-600 dark:text-white/70 dark:hover:text-white lg:px-3"
                                >
                                  {submenuItem.title}
                                </Link>
                              ))}
