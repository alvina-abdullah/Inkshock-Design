...
const categories = [
  { name: "T-Shirts", image: "/images/tshirt.png", bg: "bg-green-900" },
  { name: "Shirts", image: "/images/shirt.png", bg: "bg-gray-600" },
  { name: "Hoodies", image: "/images/hoodies.png", bg: "bg-gray-300" },
  { name: "Caps", image: "/images/caps.png", bg: "bg-white" },
];
