...
const FeatureSection = () => {
  return (
    <div className="group mt-28 dark:to-black dark:text-white">
      ...
      {/* Hero Section */}
      <section className=" flex flex-col items-center justify-between bg-gradient-to-r from-pink-500 via-orange-400 to-teal-400 px-8 py-12 text-black dark:text-white md:flex-row md:px-16 lg:px-24">
        {/* Left - Content */}
