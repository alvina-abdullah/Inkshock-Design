...
const products = [
  ...
  },
  {
    ...
    image: "/images/caps/cap3.jpg",
  },
  {
    // name: "Loose Fit Bermuda Shorts",
    image: "/images/caps/cap2.jpg",
  },
  {
    // name: "Faded Skinny Jean",
    image: "/images/caps/cap4.jpg",
  },
];
...
const Caps = () => {
  return (
    <section className="py-16 px-8 md:px-16 lg:px-24 bg-white dark:bg-black">
      {/* Section Title */}
      <h2 className="text-3xl font-bold text-center text-black dark:text-white uppercase">Caps</h2>
